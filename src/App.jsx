    ...
    <>
      <div className="pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden">
        ...
        <Routes>
          ...
          <Route path="/adminPage" element={<AdminPrivateRoute><AdminHome /></AdminPrivateRoute>} />
          <Route path="/clientPage" element={<ClientPrivateRoute><ClientHome /></ClientPrivateRoute>} />
